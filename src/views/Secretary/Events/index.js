    ...
    <Container>
      <Row className="vw-100" stlye={{ height: "vw-100" }}>
        ...
        <Col sm={9} className="mb-101">
          ...
          <input type="text" className="paraEventos" placeholder="Buscar evento por tipo" />
          <input type="text" className="paraEventos" placeholder="Buscar cliente por dni" />
          <input type="text" className="paraEventos" placeholder="Buscar propiedad por id" />
          <div className="table">
